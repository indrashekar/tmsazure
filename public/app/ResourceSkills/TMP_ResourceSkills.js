...
$http.get(ApiUrlPrefix + "fetchemployeedatabyadmin/managerEmpId=" + $scope.userinfodata.EmployeeId).success(function (response) {
...
$scope.Role=i;
$http.get(ApiUrlPrefix + 'fetchResourceSkillDetailsBasedOnUser/UserId='+UserId).success(function (data) {
...
$http.get(ApiUrlPrefix + 'searchEmployeeResourceSkillsForHR/CategoryId='+q + "/SkillId="+ r + "/Rating=" + s).success(function (data) {
$scope.employeedata=data;
...
$http.get(ApiUrlPrefix + 'searchEmployeeResourceSkillsForManager/CategoryId='+q + "/SkillId="+ r + "/Rating=" + s + "/ReportingManager=" +$scope.userinfodata.EmployeeId).success(function (data) {
$scope.managerEmployeeList = data;
