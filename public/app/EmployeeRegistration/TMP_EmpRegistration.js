...
if($scope.FirstName== undefined && $scope.LastName== undefined && $scope.Designation== undefined
...
&& $scope.HighestQualification== undefined && $scope.ContactNo== undefined && $scope.SkillId== undefined
...
}else if($scope.Designation== null || $scope.Designation== undefined||$scope.Designation==""){
...
}else if($scope.HighestQualification== null || $scope.HighestQualification== undefined||$scope.HighestQualification==""){
