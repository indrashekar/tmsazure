...
var fetchResourceSkillsByManager = function (){

};

fetchResourceSkillsByManager.fetchResourceSkillsByManager = function(req, res) { 

var managerEmpId = req.params.managerEmpId;

try {

mysql.query('SELECT DISTINCT categorymaster.CategoryName AS categoryName, skillmaster.SkillName AS skillName FROM employeemaster JOIN employeeskillmaster JOIN categorymaster JOIN skillmaster ON employeeskillmaster.CategoryId = categorymaster.CategoryId and employeeskillmaster.SkillId = skillmaster.SkillId and employeeskillmaster.IsDeleted= 0 AND employeemaster.UserId = employeeskillmaster.UserId AND employeemaster.ReportingManager =' + mysql.escape(managerEmpId), function(err, results) {
...
module.exports=fetchResourceSkillsByManager;